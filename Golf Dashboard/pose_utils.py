...
def angle_caculator(p1,p2,p3):
  m1 = (p2[1]-p1[1])/(p2[0]-p1[0])
  m2 = (p3[1]-p2[1])/(p3[0]-p2[0])
  theta = np.arctan((m2-m1)/(1+m1*m2))
  return theta

SWING_SEQUENCE = ['Address', 'Toe-up', 'Mid-Backswing', 'Top', 'Mid-Downswing', 'Impact', 'Mid-Follow-Through', 'Finish']

angles = {i:[] for i in SWING_SEQUENCE}